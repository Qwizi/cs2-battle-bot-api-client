...
T = TypeVar("T", bound="PaginatedMatchList")


@_attrs_define
class PaginatedMatchList:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = Match.from_dict(results_item_data)
        ...
        paginated_match_list.additional_properties = d
        return paginated_match_list
