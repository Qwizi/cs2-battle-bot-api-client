...
T = TypeVar("T", bound="PaginatedGuildList")


@_attrs_define
class PaginatedGuildList:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = Guild.from_dict(results_item_data)
        ...
        paginated_guild_list.additional_properties = d
        return paginated_guild_list
