...
T = TypeVar("T", bound="PaginatedSteamUserList")


@_attrs_define
class PaginatedSteamUserList:
    """ 
        Attributes:
            count (int):  Example: 123.
            results (List['SteamUser']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = SteamUser.from_dict(results_item_data)
        ...
        paginated_steam_user_list.additional_properties = d
        return paginated_steam_user_list
