...
T = TypeVar("T", bound="PaginatedDiscordUserList")


@_attrs_define
class PaginatedDiscordUserList:
    """ 
        Attributes:
            count (int):  Example: 123.
            results (List['DiscordUser']):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = DiscordUser.from_dict(results_item_data)
        ...
        paginated_discord_user_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_discord_user_list.additional_properties = d
        return paginated_discord_user_list
